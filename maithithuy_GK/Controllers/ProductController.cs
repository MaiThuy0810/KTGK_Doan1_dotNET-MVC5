...
namespace maithithuy_GK.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NameProduct,UnitPrice,ImageProduct")] Product product, HttpPostedFileBase ImageProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NameProduct,UnitPrice,ImageProduct")] Product product)
        {
            if (ModelState.IsValid)
            {
